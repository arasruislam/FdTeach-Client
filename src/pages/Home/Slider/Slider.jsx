    ...
    <Carousel className="text-center">
      <div className="relative">
        ...
        <div className="absolute left-0 top-0 right-0 h-full text-left bg-gray-800 bg-opacity-80 flex items-center">
          <div className="w-full px-2 lg:p-8 lg:w-5/6">
            <h1 className="bg-white inline p-1 text-black font-semibold shadow">
              connect with fashion
            </h1>
            <h1 className="capitalize text-5xl tracking-wide font-bold leading-[1.2] text-white">
              {" "}
            ...
            <p className="mt-12 text-gray-300 text-justify">
            ...
            <button className="btn btn-lg mt-8 text-black border-[#4FBF9F] border-0 border-b-4 hover:bg-[#4FBF9F] hover:border-white transition-all duration-300 capitalize">
              Learn More
            </button>
          </div>
        </div>
